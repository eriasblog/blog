          ...
          <div className="px-4 text-center max-h-40">
            ...
            >
              <div className="flex gap-2 items-center pl-4">
                ...
                <Combobox.Input
                  className="h-12 w-full border-0 bg-transparent text-black placeholder-gray-400 disable-ring"
              ...
              >
                {filteredProjects.map((project) => (
                  <Combobox.Option
                    ...
                    value={project}
                    className={({ active }) =>
                      `flex gap-1 disable-ring items-center text-black cursor-default leading-7 pl-1.5 ${
                ...
                {query && filteredProjects.length === 0 && (
                  <Combobox.Option
                    className="flex gap-1 px-3 pb-3 text-black leading-7"
                    key="noCookies"
